...
export default function Index() {
    ...
    const submitHandler = async () => {
        Object.keys(uploads).forEach(async(id) => {
            ...
            const S3 = await axios.post('/api/upload', S3Data, {
                headers: {
            ...
            await axios.post('/api/analyze', Textract)
                .then(res => {
                ...
                <div className={styles.S1Container}>
                    ...
                    <div className={styles.S1Content}>
                        ...
                        <div className={styles.S1Files}>
                            { uploads && Object.keys(uploads).map(id => <div className={styles.S1File} key={id}>
                                <div className={styles.S1FileHeader}>
                                    <p className={styles.S1FileName}>{uploads[id].file.name}</p>
                                    <select className={styles.S1FileTypes} onChange={e => setUploads((prevUploads: any) => {
                                        return {
                                            ...prevUploads,
                                            [id]: {
                                                ...prevUploads[id],
                                        ...
                                        <option className={styles.S1FileType} value="ac">Acta constitutiva</option>
                                        <option className={styles.S1FileType} value="csf">Constancia de situación fiscal</option>
                                        <option className={styles.S1FileType} value="id">Identificación</option>
                                    </select>
                                </div>
                        ...
                        >
                            ...
                            <div className={styles.S3ItemHeader}>
                                <div className={styles.S3HeaderText}>
                                    <p className={styles.S3ItemType}>{dictum.sociedad?.answer || 'Sociedad por definir'}</p>
                                    <p className={styles.S3ItemName}>{dictum.empresa?.answer || 'Empresa por definir'}</p>
                                    ...
                                    <div className={styles.S3DocumentContainer}>
                                        <div className={styles.S3DocumentOptions}>
                                            <div className={styles.S3OptionsText}>
                                                <p className={styles.S3OptionsType}>Sociedad Anónima de Capital Variable</p>
                                                <p className={styles.S3OptionsName}>FABRICANTE, IMPORTADOR, SUMINISTRADOR, EXPORTADOR INDUSTRIAL DEL NORTE</p>
                                            ...
                                            <div className={styles.Document} ref={targetRef}>
                                                <div className={styles.DocumentHeader}>
                                                    <div className={styles.HeaderPreface}>
                                                        ...
                                                        <Image className={styles.PrefaceLogo} src='/logo.png' width={492} height={300} alt='Logo' />
                                                    </div>
                                                </div>
                                                <div className={styles.DocumentContent}>
                                                    <div className={styles.DocumentSection}>
                                                        ...
                                                        <div className={styles.SectionRow}>
                                                            ...
                                                            <p className={styles.RowData}>{dictum.rfc?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Estatus en el padrón</p>
                                                            <p className={styles.RowData}>{dictum.estatus?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Actividad económica principal</p>
                                                            <p className={styles.RowData}>{dictum.actividad?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Nombre de la empresa</p>
                                                            <p className={styles.RowData}>{dictum.empresa?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Socios de la empresa</p>
                                                            <p className={styles.RowData}>{dictum.shareholders?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Representante legal de la empresa</p>
                                                            <p className={styles.RowData}>{dictum.representative?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Accionistas</p>
                                                            <p className={styles.RowData}>{dictum.accionistas?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Representantes</p>
                                                            <p className={styles.RowData}>{dictum.representantes?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Facultades</p>
                                                            <p className={styles.RowData}>{dictum.facultades?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Fecha de constitución</p>
                                                            <p className={styles.RowData}>{dictum.fecha?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Duración de la empresa</p>
                                                            <p className={styles.RowData}>{dictum.duracion?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Folio mercantil</p>
                                                            <p className={styles.RowData}>{dictum.folio?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Tipo de sociedad</p>
                                                            <p className={styles.RowData}>{dictum.sociedad?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Acta</p>
                                                            <p className={styles.RowData}>{dictum.acta?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Notaría de constitución</p>
                                                            <p className={styles.RowData}>{dictum.notaria?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Notario de constitución</p>
                                                            <p className={styles.RowData}>{dictum.notario?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Domicilio comercial</p>
                                                            <p className={styles.RowData}>{dictum.comercial?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Domicilio legal</p>
                                                            <p className={styles.RowData}>{dictum.legal?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Crédito</p>
                                                            <p className={styles.RowData}>{dictum.credito?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Socios</p>
                                                            <p className={styles.RowData}>{dictum.socios?.answer || 'No disponible'}</p>
                                                        </div>
                                                        <div className={styles.SectionRow}>
                                                            <p className={styles.RowCategory}>Firmantes</p>
                                                            <p className={styles.RowData}>{dictum.firmantes?.answer || 'No disponible'}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
